...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    // Base layout MAC
    [LAYER_MAC] = LAYOUT_ansi( \
        KC_ESC,                  KC_1,    KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_F12, \
        LT(LAYER_TAB, KC_TAB),   KC_Q,    KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_MPLY, \
        ...
        KC_LCTL,        KC_LALT, KC_LGUI,               KC_SPC,           MO(LAYER_FN1), MO(LAYER_FN2), KC_GRV,                   KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    // Base layout WIN
    [LAYER_WIN] = LAYOUT_ansi( \
        ...
        KC_LGUI,        KC_LALT, KC_LCTL,               KC_SPC,           MO(LAYER_FN1), MO(LAYER_FN2), KC_GRV,                   KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    ...
    [LAYER_FN1] = LAYOUT_ansi( \
        ...
        _______, _______, _______, MCR_EUR, DYN_REC, DYN_STO, _______, _______, _______, _______, KC_MPLY, DF(LAYER_MAC), DF(LAYER_WIN), _______, _______,\
    ...
    [LAYER_FN2] = LAYOUT_ansi( \
        ...
        _______, _______, _______,               _______,          _______, _______, _______,              BL_BRTG, BL_DEC, BL_STEP  \
    ),
    // Activated with one tap on CapsLock from MAC layout
    [LAYER_CAP] = LAYOUT_ansi( \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MCR_ARR, MCR_ARR2, _______, _______,\
